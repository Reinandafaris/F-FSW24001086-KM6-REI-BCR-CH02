class App {
  constructor() {
    ...
    this.carContainerElement =
      document.getElementById("cars-container");
    this.tipeDriver =
      document.getElementById("tipeDriver");
    this.tanggal =
      document.getElementById("tanggal");
    this.waktuJemput = document.getElementById(
      "waktuJemput"
    );
  ...
  async loadFilter() {
    const cars = await Binar.listCars((data) => {
      const tanggalJemputData = new Date(
        data.availableAt
      ).getTime();
      ...
      const availableAt =
        this.tipeDriver.value === "true" &&
        data.available
          ? true
          : false;
      const notAvailableAt =
        this.tipeDriver.value === "false" &&
        !data.available
          ? true
          : false;
      const penumpang =
  ...
  clear = () => {
    let child =
      this.carContainerElement.firstElementChild;
